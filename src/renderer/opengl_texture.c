...
{
    struct timespec current_timestamp = get_file_timestamp(texture->path);

    if (current_timestamp.tv_sec > texture->last_modified_timestamp.tv_sec)
    {
        // TODO: logging stuff
        printf("Hot reloading texture!");
